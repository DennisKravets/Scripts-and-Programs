...
class Frame(wx.Frame):
    def __init__(self, title):
        ...
        #Setup Add New Character UI text at the top
        ...
        self.sAge = wx.SpinCtrl(panel, value="0", size=(70, 25), pos=(130, 150))
        ...
        #run onSelect when item is selected
